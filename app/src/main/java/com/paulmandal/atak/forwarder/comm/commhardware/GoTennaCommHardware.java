...
//        super(handler, commandQueue, queuedCommandFactory, groupTracker, Config.GOTENNA_MESSAGE_CHUNK_LENGTH);
//        mHandler = handler;
...
//        } else {
//            handleGoTennaMessageChunk(messageData.getSenderGID(), messagePayload);
//        }
//    }
//
//    @Override
...
//            handleGoTennaMessageChunk(gtTextOnlyMessageData.getSenderGID(), messageChunk.getBytes());
